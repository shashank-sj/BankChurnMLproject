...
class DataTransformation:
    ...
    def get_data_transformation_object(self):
        try:
            ...
            preprocessor = ColumnTransformer([
                ...
                ("cat_pioeline",cat_pipeline,categorical_cols)
                ])
            return preprocessor
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            target_cols = "Exited"
            numerical_cols = []
            input_feature_train_df = train_df.drop(columns=["CustomerId","Surname","Exited","RowNumber"],axis=1)
            target_feature_train_df = train_df[target_cols]
            input_feature_test_df = test_df.drop(columns=["CustomerId","Surname","Exited","RowNumber"],axis=1)
